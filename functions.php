<?php
/**
 * rwrealWP functions and definitions
 *
...
if ( ! function_exists( 'rwreal_setup' ) ) :
	/**
	 ...
	 */
	function rwreal_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on rwrealWP, use a find and replace
		 * to change 'rwreal' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'rwreal', get_template_directory() . '/languages' );
...
add_action( 'wp_enqueue_scripts', 'rwreal_scripts' );
